...
以下性能数据基于 EdgeFM 与 TRT-Edge-LLM 在不同硬件平台上的对比测试结果（单位：ms）。Shape 格式为 `Prefix/Suffix`，Gap 为 EdgeFM 相对 TRT-Edge-LLM 的差值百分比，负值表示 EdgeFM 更快。完整性能表见 [edge_fm_benchmark_tables.md](doc/edge_fm_benchmark_tables.md)。
...
|-------|:--------------:|:-----------:|:-----------:|:-------------:|:----------:|:----------:|:------------:|:---------:|:---------:|
| 512/32 | 12.771 | 22.690 | -43.71% | 113.713 | 112.223 | +1.33% | 126.609 | 134.979 | -8.370 |
| 512/64 | 12.581 | 22.097 | -43.07% | 229.936 | 226.283 | +1.61% | 242.668 | 248.447 | -5.778 |
| 1024/32 | 24.929 | 25.779 | -3.30% | 115.542 | 115.702 | -0.14% | 140.586 | 141.554 | -0.969 |
| 1024/64 | 24.545 | 25.115 | -2.27% | 232.790 | 232.478 | +0.13% | 257.486 | 257.671 | -0.185 |
| 2048/32 | 48.647 | 46.500 | +4.62% | 119.411 | 122.374 | -2.42% | 168.178 | 168.969 | -0.791 |
| 2048/64 | 48.293 | 45.789 | +5.47% | 241.652 | 246.137 | -1.82% | 290.109 | 292.024 | -1.915 |

**Qwen2.5-1.5B**

| Shape | EdgeFM Prefill | TRT Prefill | Prefill Gap | EdgeFM Decode | TRT Decode | Decode Gap | EdgeFM Total | TRT Total | Total Gap |
|-------|:--------------:|:-----------:|:-----------:|:-------------:|:----------:|:----------:|:------------:|:---------:|:---------:|
| 512/32 | 37.051 | 36.739 | +0.85% | 308.966 | 308.493 | +0.15% | 346.130 | 345.300 | +0.830 |
| 512/64 | 36.460 | 36.804 | -0.94% | 627.861 | 626.698 | +0.19% | 664.482 | 663.594 | +0.888 |
| 1024/32 | 73.272 | 70.519 | +3.90% | 311.203 | 314.125 | -0.93% | 384.591 | 384.730 | -0.139 |
| 1024/64 | 73.131 | 70.548 | +3.66% | 632.115 | 637.963 | -0.92% | 705.402 | 708.590 | -3.188 |
| 2048/32 | 147.361 | 144.003 | +2.33% | 319.242 | 324.906 | -1.74% | 466.729 | 469.011 | -2.282 |
| 2048/64 | 147.445 | 144.953 | +1.72% | 648.996 | 660.188 | -1.70% | 796.607 | 805.288 | -8.681 |

**Qwen2.5-3B**

| Shape | EdgeFM Prefill | TRT Prefill | Prefill Gap | EdgeFM Decode | TRT Decode | Decode Gap | EdgeFM Total | TRT Total | Total Gap |
|-------|:--------------:|:-----------:|:-----------:|:-------------:|:----------:|:----------:|:------------:|:---------:|:---------:|
| 512/32 | 78.387 | 76.599 | +2.33% | 602.979 | 609.515 | -1.07% | 681.482 | 686.182 | -4.700 |
| 512/64 | 78.493 | 76.855 | +2.13% | 1225.296 | 1239.115 | -1.12% | 1303.951 | 1316.090 | -12.139 |
| 1024/32 | 146.907 | 141.017 | +4.18% | 610.708 | 617.041 | -1.03% | 757.754 | 758.143 | -0.389 |
| 1024/64 | 147.160 | 141.210 | +4.21% | 1240.852 | 1253.712 | -1.03% | 1388.178 | 1395.001 | -6.824 |
| 2048/32 | 297.759 | 288.021 | +3.38% | 619.143 | 631.246 | -1.92% | 917.042 | 919.372 | -2.330 |
| 2048/64 | 298.517 | 288.577 | +3.44% | 1258.738 | 1282.461 | -1.85% | 1557.436 | 1571.146 | -13.710 |
