# A800 EdgeFM 优化 Journal（归档）

归档日期：2026-04-15
原始最近更新：2026-04-13

这份文档保留的是 `NVIDIA A800 / sm80` 环境下的历史 benchmark、profiling、runtime/算子优化结论快照。
它不再作为当前主线工作文档使用，也不应直接拿来判断 `RTX 3060 / sm86` 上的保留与回退。
当前主线文档请看 `doc/edge_fm_optimization_journal.md`。
