...
| DiffusionPlanner | DrivingDiffusion/DiffusionDrive | 2-step denoise、K candidates+score | fixture-L4 + real L2，真实 L3/L4 待完成 |
...
| DiffusionDrive | L0 + L1 + real L2 + fixture-L4 | 是 | candidates/scores/trajectory fixture | real checkpoint L3–L4 |
...
4. SmolVLA real L4 与 DiffusionDrive real L2 已完成；下一优先级是 DiffusionDrive 真实 L3/L4，
