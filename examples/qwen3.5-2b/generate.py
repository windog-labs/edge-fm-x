#!/usr/bin/env python3
"""
Qwen3.5-2B Transformers smoke test.
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run a Qwen3.5-2B Transformers smoke test.")
    parser.add_argument(
        "--model-dir",
        default=str(Path(__file__).resolve().parent / "qwen3.5-2b"),
...
def main():
    ...
    if not model_dir.exists():
        ...
        print("请先在 examples/qwen3.5-2b 下执行: bash download.sh")
        return 1
