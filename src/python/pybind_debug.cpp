...
PYBIND11_MODULE(edge_fm, m) {
    ...
    m.def("qwen3_5_rmsnorm",
        ...
        .def("qwen3_5_gated_delta_sequence_from_ab_gated_rmsnorm",
             [](const Tensor& mixed_qkv,
                const Tensor& a,
                const Tensor& b,
                const Tensor& a_log,
             ...
             py::arg("eps") = 1e-6f,
             py::arg("stream") = 0,
             "Qwen3.5 decode-only fused GatedDeltaNet update + gated RMSNorm.")
        .def("qwen3_5_conv1d_gated_delta_sequence_from_ab_gated_rmsnorm",
             [](const Tensor& mixed_qkv,
             ...
             py::arg("eps") = 1e-6f,
             py::arg("stream") = 0,
             "Qwen3.5 decode-only fused conv1d + GatedDeltaNet update + gated RMSNorm.")
