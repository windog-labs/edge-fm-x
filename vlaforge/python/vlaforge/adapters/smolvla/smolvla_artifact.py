...
class SmolVLAArtifactEvidence:
    ...
    action_fidelity: dict[str, object]
    eager_seconds: float
...
def audit_real_smolvla_artifacts(
    ...
    *,
    ...
    result = SmolVLAArtifactEvidence(
        ...
        action_fidelity=compare_action_chunk(
            eager_action_cpu,
            artifact_action,
            sample_id="synthetic-single-camera-functional-audit",
            space="normalized_action",
            contract=NumericContract(
                absolute_tolerance=final_max_abs_tolerance,
                compare_tensor_hashes=False,
            ),
        ),
...
def _verify_artifact_chain(
    exports: Path, artifacts: Path, *, expected_target: str
